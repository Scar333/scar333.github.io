export const apiDoc = {
  ...
  compliance: [
    'Не используйте данные для сервисов, которые могут быть перепутаны с предложениями Wild Boar Finance.',
    'При публикации индекса указывайте Wild Boar Finance как источник и добавляйте ссылку на wildboar.space.',
    'Коммерческое использование разрешено при указании авторства и согласовании условий с командой.',
    'Правила применяются ко всем данным, возвращаемым API.'
  ],
  endpoints: [
    {
      ...
      query: [],
      headers: [
        { name: 'X-Client-Contact', required: false, description: 'Рекомендуется для быстрой поддержки инцидентов.' }
      ],
      response: {
...
fetch(url)
  ...
  changelog: [
    { date: '2025-03-01', note: 'Уточнены метрические описания и обновлена политика по X-Client-Contact.' },
    { date: '2023-11-15', note: 'Добавлено поле close в ответ для унификации с Altcoin Index.' },
    { date: '2022-04-01', note: 'Запущен публичный доступ без авторизации.' }
  ]
};
